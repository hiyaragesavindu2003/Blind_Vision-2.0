...
exports.transcribeAudio = exports.classifyCommand = void 0;
 ...
 */
const classifyCommand = async (transcript, language = "en") => {
    ...
    const obj = parsed;
    return {
        category: obj.category ?? "IRRELEVANT",
 ...
 */
const transcribeAudio = async (audioBase64, mimeType, language = "en") => {
    const model = getClient().getGenerativeModel({
        model: modelName,
